...
export class RegisterPage implements OnInit {
  ...
  /** Nombre de la carrera seleccionada (para guardarlo en los metadatos). */
  private selectedCareerName(): string {
    return (
      this.careers.find((career) => career.id === this.form.careerId)?.name ?? ''
    );
  }
